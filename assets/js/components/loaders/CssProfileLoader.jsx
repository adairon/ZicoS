      ...
      <div className="container profile border rounded py-2 bg-light shadow">
        <div className="row justify-content-center">
          ...
          <div className="col-lg-6 col-md-12 col-sm-12 profile_info p-1 my-2 ">
            <div className="mx-2 loadingProfilTitle"></div>

            <div className="instrus p-1 m-2 loadingInfo"></div>

            <div className="style p-1 m-2 loadingInfo"></div>

            <div className="level p-1 m-2 loadingInfo"></div>

            <div className="localization p-1 m-2 loadingInfo"></div>
          </div>
        </div>
        <div className="profile_bio p-1 my-2 border border-light rounded loadingProfileText"></div>

        <div className="profile_link p-1 my-2 border border-light rounded loadingProfileText"></div>
