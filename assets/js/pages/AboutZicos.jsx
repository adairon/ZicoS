        ...
        <div className="aboutContainer">
            <div className="about1 p-5 d-flex flex-column align-items-center justify-content-center">
                ...
                <div className="about_text mx-5 text-justify">
                    ZicoS est un service de mise en relation entre musiciens et groupes dans le but unique de faire de la musique. <br/>
                    ZicoS est un service gratuit à 100 %. Pas d'abonnement, pas de compte premium etc... Tout est là, sans rien payer !
                </div>
            ...
            <div className="about2 p-5 d-flex flex-column align-items-center justify-content-center">
                ...
                <Link to="/" className="btn btn-secondary mx-auto mb-4">
                    Revenir à l'accueil
                </Link>
            </div>
        </div>
